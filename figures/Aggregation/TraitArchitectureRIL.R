...
# The directory of the 'effect_size.csv' outputs of QtlMonteCarlo
...
qtl1_100 <- read.csv("qtl_1_Ne_1000_var_0.4_2026-02-26_21_53/effect_size.csv")
qtl1_100$qtl <- 1
qtl1_100$var <- 0.4

# 200 pop resets x 2 sims (N=400)
qtl1_400 <- read.csv("qtl_1_Ne_1000_var_0.4_2026-02-27_22_27/effect_size.csv")
qtl1_400$qtl <- 1
qtl1_400$var <- 0.4

# QTL: 2 V: 0.4
# 50 pop resets x 2 sims (N=100)
qtl2_100 <- read.csv("qtl_2_Ne_1000_var_0.4_2026-02-27_00_24/effect_size.csv")
qtl2_100$qtl <- 2
qtl2_100$var <- 0.4

# 100 pop resets x 2 sims (N=200)
qtl2_200_a <- read.csv("qtl_2_Ne_1000_var_0.4_2026-02-28_08_42/effect_size.csv")
qtl2_200_a$qtl <- 2
qtl2_200_a$var <- 0.4

# 100 pop resets x 2 sims (N=200)
qtl2_200_b <- read.csv("qtl_2_Ne_1000_var_0.4_2026-03-01_21_25/effect_size.csv")
qtl2_200_b$qtl <- 2
qtl2_200_b$var <- 0.4

# QTL: 5 V: 0.4
# 50 pop resets x 2 sims (N=100)
qtl5_100 <- read.csv("qtl_5_Ne_1000_var_0.4_2026-02-27_02_55/effect_size.csv")
qtl5_100$qtl <- 5
qtl5_100$var <- 0.4

# 100 pop resets x 2 sims (N=200)
qtl5_200_a <- read.csv("qtl_5_Ne_1000_var_0.4_2026-02-28_13_52/effect_size.csv")
qtl5_200_a$qtl <- 5
qtl5_200_a$var <- 0.4

# 100 pop resets x 2 sims (N=200)
qtl5_200_b <- read.csv("qtl_5_Ne_1000_var_0.4_2026-03-02_02_39/effect_size.csv")
qtl5_200_b$qtl <- 5
qtl5_200_b$var <- 0.4

ril_df <- rbind(qtl1_100,
                qtl1_400,
                qtl2_100,
                qtl2_200_a,
                qtl2_200_b,
